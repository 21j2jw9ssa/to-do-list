...
const defaultTxt = "👇 click to choose a sorting" ;
const defaultBackColourEnabled  = toggle.style.backgroundColor ;
const defaultBackColourDisabled = "#ffefbf" ;

toggle.textContent = defaultTxt ;
...
function enableDropdown() {
  ...
  // style
  toggle.style.backgroundColor = defaultBackColourEnabled ;
...
function disableDropdown() {
  ...
  // style
  toggle.style.backgroundColor = defaultBackColourDisabled ;
